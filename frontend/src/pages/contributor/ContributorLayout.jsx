...
export default function ContributorLayout() {
  ...
  // Tutup sidebar otomatis di mobile saat route berubah
      ...
      <div style={{ width: sidebarOpen ? 240 : 64, minWidth: sidebarOpen ? 240 : 64, background: SIDEBAR_BG, display: 'flex', flexDirection: 'column', transition: 'width 0.25s ease, min-width 0.25s ease', overflow: 'hidden', zIndex: 200, flexShrink: 0 }}>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', padding: sidebarOpen ? '14px 18px' : '14px 8px' }}>
          ...
          <button onClick={handleLogout} title="Logout"
            style={{ width: '100%', background: 'rgba(255,255,255,0.07)', border: 'none', borderRadius: 8, color: 'rgba(255,255,255,0.6)', padding: '8px 0', fontSize: 12, fontWeight: 500, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'background 0.15s', fontFamily: "'Inter', sans-serif" }}
